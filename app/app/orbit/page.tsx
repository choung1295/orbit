            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                <div className="flex items-center gap-3 px-4 h-14 border-b border-[#2a2a35] shrink-0">
                    <button
                        ...
                        className="p-2 rounded-lg text-[#606070] hover:text-[#f0f0f5] hover:bg-[#22222a] transition-all"
                        aria-label="사이드바 토글"
                    >
                    ...
                    <div className="ml-auto flex items-center gap-2">
                        <span className="px-2.5 py-1 rounded-full text-xs font-medium bg-indigo-600/15 text-indigo-400 border border-indigo-500/20">
                            GPT-4o
                        </span>
                    </div>
                </div>
