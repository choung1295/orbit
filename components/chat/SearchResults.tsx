...
export default function SearchResults({
    ...
    if (isSearching) {
        return (
            <div className="px-3 py-4">
                <p className="text-xs text-[#404050] animate-pulse italic text-center">
                    Searching...
                </p>
            </div>
        )
    ...
    if (results.length === 0) {
        return (
            <div className="px-3 py-4">
                <p className="text-xs text-[#404050] text-center">
                ...
                {results.map((result) => {
                    ...
                    return (
                        ...
                        >
                            {/* 제목 */}
                            <p
                                className={`text-xs font-medium truncate mb-0.5 ${isActive ? "text-[#f0f0f5]" : "text-[#b0b0c0] group-hover:text-[#e0e0e8]"
                                    }`}
                            >
